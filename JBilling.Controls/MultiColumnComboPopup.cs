...
namespace JBilling.Controls
{
    ...
    public class MultiColumnComboPopup : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lstvMyView.Click += new System.EventHandler(this.lstvMyView_DoubleClick);
            // 
        ...
        private void InitializeGridProperties()
        {
            ...
            {
                lstvMyView.Columns.Add(columnsToDisplay[i], columnsToDisplay[i].Length * 8, HorizontalAlignment.Left);
            }
